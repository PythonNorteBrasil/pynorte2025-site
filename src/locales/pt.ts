export default {
  ...
  "component.hero.description":
    "O maior evento de Python do região norte do Brasil. Junte-se a nós em Belém do Pará para 3 dias de aprendizado, networking e cultura amazôniza.",
  ...
  "component.hero.accessRepository":
    "Acesse nosso repositório e guarda de lembrança!",
  ...
  "component.location.description":
    "O Python Norte 2025 será realizado na Universidade da Amazônia (UNAMA) da Alcindo Cacela, proporcionando uma estrutura completa para o evento com fácil acesso. O campus Alcindo Cacela é um dos principais pontos de referência educacional de Belém.",
  ...
  "page.codeOfConduct.rules.3":
    "Toda pessoa presente no evento, independentemente do seu papel, está sujeita a estas regras.",
  "page.codeOfConduct.definitions.title": "Desta forma, entendemos que:",
  "page.codeOfConduct.definitions.1":
    "Assédio é qualquer comportamento que viole o bom-humor, a intimidade ou a dignidade de outra pessoa.",
  "page.codeOfConduct.definitions.2":
    "Discriminação inapropriada é qualquer comportamento que viole o bom-humor, a intimidade ou a dignidade de outra pessoa.",
  "page.codeOfConduct.definitions.3":
    "Humilhação pública é qualquer comportamento que viole o bom-humor, a intimidade ou a dignidade de outra pessoa.",
